...
CREATE TABLE "Transaction" (
    ...
    "customerMarkedPaid" BOOLEAN NOT NULL DEFAULT false,
...
CREATE TABLE "twilio_numbers" (
    ...
    CONSTRAINT "twilio_numbers_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "User" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
...
CREATE TABLE "conversations" (
    ...
    CONSTRAINT "conversations_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "User" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
    CONSTRAINT "conversations_customer_id_fkey" FOREIGN KEY ("customer_id") REFERENCES "Customer" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
-- CreateIndex
CREATE UNIQUE INDEX "Transaction_invoiceToken_key" ON "Transaction"("invoiceToken");
